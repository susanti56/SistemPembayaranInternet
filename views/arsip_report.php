            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">Id Transaksi</th><th>Id Pelanggan</th><th width="15%">Nominal</th><th width="10%">Tgl. Bayar</th><th>Tgl. Validasi</th><th>Status</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['nominal'] ?></td>
									                  ...
									                  <td><?= $data['status'] ?></td>
                                    <td>
                                        <a href="report/arsip_satu.php?id=<?= $data['id_transaksi'] ?>" target="_blank" class="btn btn-info btn-xs">
