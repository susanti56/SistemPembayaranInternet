...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?page=utama">Sistem Informasi Pembayaran Paket Internet</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=v&actions=pelanggan">Data Pelanggan</a></li>
                        <li><a href="?page=v&actions=paket">Data Paket</a></li>
                    </ul>
                </li>
                <li class="dropdown">
